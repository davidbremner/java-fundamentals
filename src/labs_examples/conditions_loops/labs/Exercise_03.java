...
public class Exercise_03 {
    public static void main(String[] args) {
        ...
        System.out.println("Give me a number from 1-12 to see which month it corresponds with: ");
        String month = getMonthOfYear(scanner.nextInt());
        System.out.println(month);
    }

    public static String getMonthOfYear(int monthNum) {
        String month;
        switch(monthNum) {
            case 1:
                month = "January";
